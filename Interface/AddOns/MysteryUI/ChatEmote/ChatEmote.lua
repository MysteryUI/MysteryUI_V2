...
local emotes = {
	...
	{"{天使}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Angel]=]},
	{"{生气}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Angry]=]},

	{"{大笑}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Biglaugh]=]},
	{"{鼓掌}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Clap]=]},
	{"{酷}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Cool]=]},
	{"{哭}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Cry]=]},
	{"{可爱}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Cutie]=]},
	{"{鄙视}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Despise]=]},
	{"{美梦}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Dreamsmile]=]},
	{"{尴尬}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Embarrass]=]},
	{"{邪恶}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Evil]=]},
	{"{兴奋}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Excited]=]},

	{"{晕}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Faint]=]},
	{"{打架}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Fight]=]},
	{"{流感}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Flu]=]},
	{"{呆}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Freeze]=]},
	{"{皱眉}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Frown]=]},
	{"{致敬}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Greet]=]},
	{"{鬼脸}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Grimace]=]},
	{"{龇牙}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Growl]=]},
	{"{开心}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Happy]=]},
	{"{心}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Heart]=]},

	{"{恐惧}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Horror]=]},
	{"{生病}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Ill]=]},
	{"{无辜}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Innocent]=]},
	{"{功夫}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Kongfu]=]},
	{"{花痴}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Love]=]},
	{"{邮件}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Mail]=]},
	{"{化妆}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Makeup]=]},
	{"{马里奥}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Mario]=]},
	{"{沉思}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Meditate]=]},
	{"{可怜}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Miserable]=]},

	{"{好}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Okay]=]},
	{"{漂亮}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Pretty]=]},
	{"{吐}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Puke]=]},
	{"{握手}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Shake]=]},
	{"{喊}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Shout]=]},
	{"{闭嘴}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Shuuuu]=]},
	{"{害羞}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Shy]=]},
	{"{睡觉}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Sleep]=]},
	{"{微笑}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Smile]=]},
	{"{吃惊}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Suprise]=]},

	{"{失败}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Surrender]=]},
	{"{流汗}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Sweat]=]},
	{"{流泪}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Tear]=]},
	{"{悲剧}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Tears]=]},
	{"{想}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Think]=]},
	{"{偷笑}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Titter]=]},
	{"{猥琐}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Ugly]=]},
	{"{胜利}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Victory]=]},
	{"{雷锋}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Volunteer]=]},
	{"{委屈}",	[=[Interface\Addons\MysteryUI\ChatEmote\icon\Wronged]=]},
}
